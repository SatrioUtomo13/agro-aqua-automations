...
import FisheryDashboard from "../FisheryDashboard";
import React from 'react'

const page = () => {
    return (
        <main className='className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50 flex items-center justify-center "'>
